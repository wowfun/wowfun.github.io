...
![alt text](../assets/fauni-search/faunisearch-1.png)
...
![alt text](../assets/fauni-search/search-raw.png)

下面是我花费了很多精力，用了多个设计工具和提示词技巧反复迭代出的让我还算满意的原型设计（不代表最终实现效果图）。

![alt text](../assets/fauni-search/search-ready-empty.png)

![alt text](../assets/fauni-search/search-ready-results.png)
...
![alt text](../assets/fauni-search/t2d.文搜文档中的表格.gif)

案例 t2d-2：搜小米2025年中期报告总结性信息图
![alt text](../assets/fauni-search/t2d.文搜文档中的信息图.gif)

案例 t2d-3：搜太阳能光伏板图片
![alt text](../assets/fauni-search/t2d.文搜文档中的图片.gif)

#### 文搜图片内容
案例 t2i-1：搜与问题相关的内容：What is the percentage change in current assets from 2018 to 2019?
![alt text](../assets/fauni-search/t2i.文搜图片中的内容.gif)

#### 文搜视频片段
案例 t2v-1：搜出现终端界面的片段
![alt text](../assets/fauni-search/t2v.文搜视频中的相关片段.gif)

### 3.2 Image as Query
#### 图搜文档内容
案例 i2d-1：搜包含相同或相关图片的文档页
![alt text](../assets/fauni-search/i2d.图搜文档中的表格.gif)

案例 i2d-2：搜包含机器人图像的文档页
![alt text](../assets/fauni-search/i2d.图搜文档中的相似图.gif)

#### 图搜视频片段
案例 i2v-1：搜包含相同或相关图片的视频片段
![alt text](../assets/fauni-search/i2v.图搜视频片段.gif)
